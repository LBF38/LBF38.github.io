...
<H1 class="my-2 w-full">
	<span
		class="block w-full bg-gradient-to-tr from-teal-300 to-purple-400 box-decoration-clone bg-clip-text text-transparent dark:from-teal-600 dark:to-purple-900"
	>
